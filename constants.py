from os import path
from utils_bert import count_num_cpu_gpu
...
MAX_SENTIMENT_SEQ_LENGTH = 400
MAX_KB_ARR_LENGTH = 100
TOP_K = 10
...
DIALOGUE_MODELS_DIR = f"{MODELS_DIR}/Dialogue"
DIALOGUE_EXPERIMENTS_DIR = f"{EXPERIMENTS_DIR}/Dialogue"

DIALOGUE_ANNOTATOR_DATASETS_DIR = f"{CAUSALM_DIR}/Dialogue_Annotator/datasets"
DIALOGUE_ANNOTATOR_MODELS_DIR = f"{DIALOGUE_MODELS_DIR}/Annotator"
DIALOGUE_ANNOTATOR_PRETRAIN_DIR = f"{DIALOGUE_ANNOTATOR_MODELS_DIR}/Pretrain"
DIALOGUE_ANNOTATOR_PRETRAIN_DATA_DIR = f"{DIALOGUE_ANNOTATOR_PRETRAIN_DIR}/data"
DIALOGUE_ANNOTATOR_PRETRAIN_MLM_DIR = f"{DIALOGUE_ANNOTATOR_PRETRAIN_DIR}/MLM"
DIALOGUE_ANNOTATOR_PRETRAIN_DST_DIR = f"{DIALOGUE_ANNOTATOR_PRETRAIN_DIR}/DST"
