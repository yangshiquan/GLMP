...
def prepare_data_seq(task, batch_size=100):
    file_train = 'data/KVR/{}train_transformed.txt'.format(task)
    file_dev = 'data/KVR/{}dev_transformed.txt'.format(task)
    file_test = 'data/KVR/{}test_transformed.txt'.format(task)
