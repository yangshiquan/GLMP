...
from utils.utils_tensorflow_generator_multiwoz_knowledge_graph import *
...
def text_to_sequence(pairs, lang):
    ...
    for pair in pairs:
        ...
        sequence_data.append({
            ...
            'ent_idx_restaurant': pair['ent_idx_restaurant'],
            'ent_idx_hotel': pair['ent_idx_hotel'],
            'ent_idx_attraction': pair['ent_idx_attraction'],
            'ent_idx_train': pair['ent_idx_train'],
            'ent_idx_hospital': pair['ent_idx_hospital']
        })
    return sequence_data


def prepare_data_seq(task, batch_size=100):
    file_train = 'data/MULTIWOZ2.1/{}train_transformed_full_features.txt'.format(task)
    file_dev = 'data/MULTIWOZ2.1/{}dev_transformed_full_features.txt'.format(task)
    file_test = 'data/MULTIWOZ2.1/{}test_transformed_full_features.txt'.format(task)
