...
from utils.utils_general_for_contrastive_learning import *
...
def prepare_data_seq(task, batch_size=100):
    ...
    file_paired_examples = '/Users/shiquan/PycharmProjects/GLMP/data/multiwoz/paired_examples_for_contrastive_learning_delete_one_word.txt'
