...
dataset = "train"
input_path_1 = "../data/MULTIWOZ2.1/for_debug_edge_paris.txt".format(dataset)
input_path_2 = "../data/MULTIWOZ2.1/for_debug.txt".format(dataset)
output_path = "../data/MULTIWOZ2.1/for_debug_transformed.txt".format(dataset)
...
with open(input_path_2) as f:
    ...
    for line in f:
        ...
        if line:
            ...
            if int(nid) <= 30 and 'image' not in line:  # KB
